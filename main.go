...
//go:generate oapi-codegen --package=common --generate types -o pkg/common/types.gen.go api/api.yaml
//go:generate oapi-codegen --package=common --generate spec -o pkg/common/spec.gen.go api/api.yaml
